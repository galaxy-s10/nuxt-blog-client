<template>
  <div class="pages-wrap">
    <div v-if="isFirst">
      <!-- 骨架屏的样式 loading -->
      <div ref="skeleton-wrap" class="skeleton-wrap" style="height: 1800px">
        <div class="masonry-item">
          ...
          <div style="padding: 0 10px 10px">
            <h3 class="loading-block" style="width: 80%"></h3>
            <div>
              <p class="loading-block"></p>
              <div class="flex">
                <div
                  class="loading-block"
                  :style="{
        ...
        <div class="masonry-item">
          <div
            class="loading-block"
            style="height: 220px; background-color: #ededed"
          ></div>
          <div style="padding: 0 10px 10px">
            <h3 class="loading-block" style="width: 80%"></h3>
            <div>
        ...
        <div class="masonry-item">
          <div
            class="loading-block"
            style="height: 260px; background-color: #ededed"
          ></div>
          <div style="padding: 0 10px 10px">
            <h3 class="loading-block" style="width: 80%"></h3>
            <div>
        ...
        <div class="masonry-item">
          <div
            class="loading-block"
            style="height: 210px; background-color: #ededed"
          ></div>
          <div style="padding: 0 10px 10px">
            <h3 class="loading-block" style="width: 80%"></h3>
            <div>
        ...
        <div class="masonry-item">
          <div
            class="loading-block"
            style="height: 280px; background-color: #ededed"
          ></div>
          <div style="padding: 0 10px 10px">
            <h3 class="loading-block" style="width: 80%"></h3>
            <div>
        ...
        <div class="masonry-item">
          <div
            class="loading-block"
            style="height: 160px; background-color: #ededed"
          ></div>
          <div style="padding: 0 10px 10px">
            <h3 class="loading-block" style="width: 80%"></h3>
            <div>
...
export default {
  ...
  watch: {
    '$store.state.article.pageList': {
      ...
      handler(newValue, oldValue) {
        ...
        if (this.nowPage !== 1) {
          ...
          //   this.end = true
          // }
          this.articleList = this.list.concat(newValue)
        } else {
          this.articleList = []
          this.$nextTick(() => {
            this.offsetList = []
    ...
    type_id(newval, oldval) {
      ...
      this.$nextTick(() => {
        this.$refs['waterfall-wrap'].style.height = '0px'
        this.$refs['skeleton-wrap'] && this.masonry()
      })
  ...
  methods: {
    ...
    waterfall() {
      ...
      for (
        let i = this.articleList.length - this.ajaxGetNum;
        i < item.length;
        i++
      ) {
    ...
    masonry() {
      ...
      // 间隙
      const gap = this.masonryParams.gap
      const wrap = this.$refs['skeleton-wrap']
...
<style scoped>
.pages-wrap /deep/ .el-loading-mask {
